...
>(({ className, children, ...props }, ref) => {
  // Keep track of dialog open state to control focus trap
  const [isOpen, setIsOpen] = React.useState(false);
  
  React.useEffect(() => {
    // Detect when dialog is open (using animation state)
    ...
    // Handle either a ref object or a callback ref safely
